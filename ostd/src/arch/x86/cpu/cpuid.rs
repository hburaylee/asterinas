...
/// Returns whether the system is running in QEMU.
///
/// This function uses the CPUID instruction to detect the QEMU hypervisor signature.
pub(in crate::arch) fn is_running_in_qemu() -> bool {
...
/// Returns whether the system is running under KVM.
pub(in crate::arch) fn is_running_under_kvm() -> bool {
    let Some(signature) = query_hypervisor_signature() else {
        return false;
    };
...
/// Returns the 12-byte hypervisor signature.
